...
module OV7670_config_rom (
    ...
    always @(posedge clk) begin
        case (addr)
            ...
            25:
            dout <= 16'h1E_20; //MVFP       disable mirror / flip //might have magic value of 03
            ...
            74: dout <= 16'h69_07;
            75: dout <= 16'h41_10;  // COM16  bit4=1 → Auto De-noise ON
            76: dout <= 16'h4C_20;  // DNSTH  '0x20' 정도면 중간 세기
            77: dout <= 16'h77_10;  // REG77  De-noise offset (선택, 0x10~0x20 권장)
