...
##Switches
# set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports sw_gray]
# set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports sw_upscale]
...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports sw_gray]; #IO_L24N_T3_34 Sch=btn[1]
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports sw_upscale]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
# set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { btn[3] }]; #IO_L7P_T1_34 Sch=btn[3]


# ##LEDs
# set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { clk_led }]; #IO_L23P_T3_35 Sch=led[0]
...
# 카메라 픽셀 클럭 강제 일반 라우트 허용
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov7670_pclk_IBUF]

##Pmod Header JA (XADC)
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports ov7670_scl]
set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports ov7670_sda]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports ov7670_v_sync]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports ov7670_href]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports ov7670_pclk]
set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports ov7670_xclk]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports tx_out]
#set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { ja[7] }]; #IO_L20N_T3_AD6N_35 Sch=JA4_R_N


##Pmod Header JB (Zybo Z7-20 only)
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[7]}]
set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[6]}]
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[5]}]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[4]}]
set_property -dict {PACKAGE_PIN Y7 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[3]}]
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[2]}]
set_property -dict {PACKAGE_PIN V6 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[1]}]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports {ov7670_data[0]}]
